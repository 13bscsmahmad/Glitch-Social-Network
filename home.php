                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div class="timeline">
                                                        ...
                                                        <div class="timeline-detail">
                                                            <div class="timeline-head">
                                                                <h3><strong>Hamza Masud</strong> bragged about DOTA<span>4 min ago</span></h3>
                                                            </div>
                                                            <div class="timeline-content">
                                                ...
                                                <li>
                                                    <div class="timeline">
                                                        ...
                                                        <div class="timeline-detail">
                                                            <div class="timeline-head">
                                                                <h3><strong>Hamza Masud</strong> unlocked an achievement in <strong>Batman Arkham Asylum</strong><span>4 min ago</span></h3>
                                                            </div>
                                                            <div class="timeline-content">
                                                                <p><img src="http://cdn.akamai.steamstatic.com/steamcommunity/public/images/apps/35140/4d059fa60652ec59e4d82793a50a146142d86350.jpg" /> <strong>Perfect Knight</strong></p>
                                                                <div data-toggle="buttons" class="btn-group btn-group-sm">
                                                                    <label class="btn btn-default">
                                                                        <input type="radio"  name="options" />
                                                                        <i class="fa fa-thumbs-o-up"></i> Thumbs Up! </label>
